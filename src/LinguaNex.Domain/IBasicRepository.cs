...
namespace LinguaNex.Domain
{
    public interface IBasicRepository<TEntity, TKey> where TEntity : class
    {
        ...
        Task<TEntity?> FindAsync(Expression<Func<TEntity, bool>> predicate, CancellationToken cancellationToken = default, params Expression<Func<TEntity, object>>[] propertySelectors);
